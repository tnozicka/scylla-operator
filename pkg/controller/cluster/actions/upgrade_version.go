...
func (a *ClusterVersionUpgrade) beginUpgrade(ctx context.Context) (fsm.Event, error) {
	...
	now := timeutc.Now()
	err := a.upgradeClusterStatus(ctx, func(status *scyllav1.ScyllaClusterStatus) {
...
func (a *ClusterVersionUpgrade) findNextRack(ctx context.Context) (fsm.Event, error) {
	...
	if err := a.upgradeClusterStatus(ctx, func(status *scyllav1.ScyllaClusterStatus) {
		if r == nil {
...
func (a *ClusterVersionUpgrade) upgradeClusterStatus(ctx context.Context, f func(cluster *scyllav1.ScyllaClusterStatus)) error {
	cluster := &scyllav1.ScyllaCluster{}
